import { Controller, Get, Post, Put, Delete, Body, Param, ParseIntPipe, UseGuards, Req, HttpCode, HttpStatus } from '@nestjs/common';
...
export class ServiceCategoryController {
    ...
    @Put(':id')
    update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateServiceCategoryDto, @Req() req: any) {
