...
- El `plan_id` guardado no siempre es lo que el usuario ve: durante la prueba la respuesta dice
  **Full** porque es lo que está usando. Confía en la respuesta, no en la BD.
